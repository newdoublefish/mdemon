...
public class MainActivity extends BaseActivity {
	...
	private BtDiscoveFragment btdiscoverFragment;
...
//		MobclickAgent.setDebugMode( true );
		...
		btdiscoverFragment=new BtDiscoveFragment();
		settingFragment = new SettingsFragment();
		fragments = new Fragment[] { chatHistoryFragment, contactListFragment,settingFragment, btdiscoverFragment};
		// 添加显示第一个fragment
	...
	private void initView() {
		...
		mTabs[3] = (Button) findViewById(R.id.btn_btdiscover);
		// 把第一个tab设为选中状态
	...
	public void updateNewDiscoverLable()
	{
	    runOnUiThread(new Runnable()
	    {
	        public void run(){
	            if(btdiscoverFragment.isAnyNewDiscover())
	            {

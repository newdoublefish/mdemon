...
public class SettingsFragment extends Fragment implements OnClickListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		rl_me_setting=(LinearLayout)getView().findViewById(R.id.me_list);
		...
		rl_me_setting.setOnClickListener(this);
	...
	public void showMe()
	{	    
	    startActivity(new Intent(getActivity(), MeSettingActvity.class));
	}
